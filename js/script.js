...
function windowScroll(e) {
  ...
  const goTopClass =
    "goTop btn btn-secondary fixed-bottom mr-3 mb-3 ml-auto border-0";
...
//     btnChangeTheme.className =
//       "btnChangeTheme btn btn-outline-light btn-sm border-0 ml-3";
//     btnChangeThemeI.className = "fas fa-moon";
//   } else {
//     html.dataset.colorMode = "light";
//     btnChangeTheme.className =
//       "btnChangeTheme btn btn-outline-dark btn-sm border-0 ml-3";
